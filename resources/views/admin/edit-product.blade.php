...
@section('title', 'Edit Product - DailyBrew')
...
<div class="container py-4">
    ...
    <div class="row mb-4">
        <div class="col-12">
            ...
            <h2 class="fw-bold mb-0"><i class="fas fa-edit me-2 text-primary"></i>Edit Product</h2>
            <p class="text-muted">Update details for "{{ $beverage->name }}"</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-3 p-4 shadow-sm">
        <form method="POST" action="{{ route('beverage.update', $beverage->id) }}" enctype="multipart/form-data" class="needs-validation" novalidate>
            @csrf
            @method('PUT')
                    ...
                    <div class="card border-0 shadow-sm mb-4">
                        ...
                        <div class="card-body p-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid @enderror" 
                                               id="name" name="name" value="{{ old('name', $beverage->name) }}" 
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select class="form-select @error('brand_id') is-invalid @enderror" 
                                            ...
                                            @foreach($brands as $brand)
                                                <option value="{{ $brand->id }}" {{ old('brand_id', $beverage->brand_id) == $brand->id ? 'selected' : '' }}>
                                                    {{ $brand->name }}
                                                </option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="number" class="form-control @error('price') is-invalid @enderror" 
                                               id="price" name="price" value="{{ old('price', $beverage->price) }}" 
                                ...
                                <!-- Status (is_available) -->
                                <div class="col-md-4">
                                    <label for="is_available" class="form-label fw-semibold">Availability Status</label>
                                    <div class="input-group mb-3">
                                        ...
                                        <select class="form-select @error('is_available') is-invalid @enderror" 
                                            ...
                                            <option value="1" {{ old('is_available', $beverage->is_available ? '1' : '0') == '1' ? 'selected' : '' }}>
                                                Available
                                            </option>
                                            <option value="0" {{ old('is_available', $beverage->is_available ? '1' : '0') == '0' ? 'selected' : '' }}>
                                                Not Available
                                            </option>
                                        </select>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" 
                                          ...
                                          placeholder="Describe your product..." required>{{ old('description', $beverage->description) }}</textarea>
                            ...
                            <div class="mb-3 text-center">
                                <div class="mb-3 position-relative">
                                    <div class="bg-light rounded-3 py-5 px-3 mb-3 text-center d-flex align-items-center justify-content-center" 
                                        ...
                                        @if($beverage->image)
                                            <img src="{{ asset('storage/' . $beverage->image) }}" alt="Current Product Image" 
                                ...
                                <div class="form-text">Upload a new image (JPEG, PNG). Max size: 2MB. Leave empty to keep current image.</div>
                            </div>
                        </div>
                    </div>
