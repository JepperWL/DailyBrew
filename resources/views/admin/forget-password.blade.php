...
<head>
  ...
  <title>Admin Forget Password - DailyBrew</title>
  ...
  <div class="container-fluid p-0">
    <div class="row g-0 min-vh-100" style="background: url('{{ asset('storage/admin-login-bg.jpg') }}') no-repeat center center fixed; background-size: cover;">
      ...
      <div class="col-12 d-flex justify-content-center align-items-center pt-5">
        <div class="card text-white rounded-4 shadow p-4 p-md-5 my-5 w-100 border-start border-warning border-4" style="max-width: 520px; min-height: 600px; background-color: rgba(0, 32, 19, 0.85);">
          ...
          <div class="text-center mb-4">
            ...
            <div class="d-flex align-items-center justify-content-center gap-2 mb-2">
              ...
              <h2 class="fw-bold text-warning mb-0">Admin Forget Password</h2>
            </div>
            <p class="text-white-50">Enter your admin email to verify your account</p>
          </div>
