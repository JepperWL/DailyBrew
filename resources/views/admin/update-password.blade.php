...
<head>
  ...
  <title>Admin Update Password - DailyBrew</title>
  ...
  <div class="container-fluid p-0">
    <div class="row g-0 min-vh-100" style="background: url('{{ asset('storage/admin-login-bg.jpg') }}') no-repeat center center fixed; background-size: cover;">
      ...
      <div class="col-12 d-flex justify-content-center align-items-center pt-5">
        <div class="card text-white rounded-4 shadow p-4 p-md-5 my-5 w-100 border-start border-warning border-4" style="max-width: 520px; min-height: 650px; background-color: rgba(0, 32, 19, 0.85);">
          ...
          <div class="text-center mb-4">
            ...
            <div class="d-flex align-items-center justify-content-center gap-2 mb-2">
              ...
              <h2 class="fw-bold text-warning mb-0">Admin Update Password</h2>
            </div>
          ...
          <!-- Form -->
          <form method="POST" action="{{ route('admin.update-password.submit') }}">
            @csrf
            ...
            <div class="mb-4">
              ...
              <div class="text-danger small mt-1">{{ $message }}</div>
              @enderror
              <div id="password-feedback" class="form-text text-warning mt-2 d-none">
                <i class="fas fa-exclamation-triangle me-1"></i> Passwords do not match!
              </div>
            </div>

            <button type="submit" class="btn btn-success text-warning fw-bold w-100 rounded-pill py-3 mb-3" id="updateBtn">
              <i class="fas fa-save me-2"></i>Update Password
            </button>
            
            <div class="text-center mt-4">
              <a href="{{ route('admin.forget-password') }}" class="text-white-50 text-decoration-none">
                <i class="fas fa-arrow-left me-1"></i> Back to Email Verification
              </a>
            </div>
